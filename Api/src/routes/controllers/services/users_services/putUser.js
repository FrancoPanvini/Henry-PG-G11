...
async function putUser(req, res) {
  ...
  try {
    await Users.update({ name, phone, mail, responsable, description,link_donaciones, link_instagram, link_web, link_facebook, CityId, lat, lng, direction, UsersTypeId, photo }, { where: { id: parseInt(id) } });
