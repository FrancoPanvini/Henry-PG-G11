    ...
    return (
        <div className=" flex justify-between px-4 bg-gradient-to-r from-thirty to-fourty items-center text-white ">
          ...
          <div className="grid grid-cols-5 text-center items-center">
            ...
            <NavLink to="/adopciones" className="p-4 text-center focus:text-primary hover:text-primary" activeClassName="border-b-4 border-primary text-primary" >ADOPCIONES</NavLink>
            <NavLink to="/perdidos" className="p-4 text-center focus:text-primary hover:text-primary" activeClassName="border-b-4 border-primary text-primary" >PERDIDOS</NavLink>
            <NavLink to="/refugios" className="p-4 mr-12 text-center focus:text-primary hover:text-primary" activeClassName="border-b-4 border-primary text-primary" >REFUGIOS</NavLink>  
