    ...
    return (
        <div className="flex justify-between px-4 bg-gradient-to-r from-thirty to-fourty items-center text-white">
          ...
          <div className="grid grid-cols-5 text-center items-center">
            ...
            <NavLink to="/adopciones" className="p-4 text-center focus:text-primary hover:text-primary">PERDIDOS</NavLink>
            <NavLink to="/adopciones" className="p-4 mr-12 text-center focus:text-primary hover:text-primary">REFUGIOS</NavLink>  
            <div className="grid grid-cols-2 text-center text-md p-2">
                ...
                <NavLink to="/login" className="bg-primary btn btn-nav border-secondary py-1">Registro</NavLink>
