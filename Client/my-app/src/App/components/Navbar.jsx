    ...
    <div className=" flex justify-between items-center px-4 h-screen9 bg-gradient-to-r from-thirty to-fourty  text-white ">
      ...
      <div className="h-full grid grid-cols-6 text-center">
        <NavLink
          to="/"
          exact
          className="h-full w-36 flex items-center justify-center hover:text-primary"
          activeClassName="shadow-activeNavBar text-primary"
        >
          INICIO
        </NavLink>
        <NavLink
        ...
        <NavLink
          to="/refugios"
          className="h-full w-36 flex items-center justify-center mr-4 hover:text-primary"
          activeClassName="shadow-activeNavBar text-primary"
        >
          REFUGIOS
        </NavLink>
        ...
        {isLogged ? (
          ...
          <div className="flex flex-col justify-center text-center text-md pt-1">
            <NavLink
              to="/perfil"
              className="bg-primary btn btn-nav w-full border-b-fourty mr-2"
              activeClassName="navButtonActive"
            >
              Perfil
            </NavLink>
            <button
              className="bg-fourtyDark btn btn-nav w-full border-b-0"
          ...
          <div className="flex flex-col justify-center text-center text-md pt-1">
            ...
            <NavLink
              to="/registro"
              className="bg-fourtyDark btn btn-nav w-full"
              activeClassName="navButtonActive"
            >
              Registro
            </NavLink>
