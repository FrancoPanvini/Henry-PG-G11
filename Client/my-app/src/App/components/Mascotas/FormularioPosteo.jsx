      ...
      <div className='fixed inset-0 z-50'>
        ...
        <form className='panel flex flex-col w-4/5 max-w-3xl mx-auto bg-gradient-to-r from-primaryDark to-primary relative'>
          ...
          <label>
            ...
            {errors.name && (
              <FaExclamationCircle title={errors.name} className='inline text-fourtyLight align-baseline' />
            )}
          </label>
          ...
          <div className='flex justify-evenly'>
            <div className='text-center w-2/5 rounded-2xl bg-secondaryDark px-4 py-2'>
              <label>
                Especie:{' '}
                {errors.PetsTypeid && (
                  <FaExclamationCircle title={errors.PetsTypeid} className='inline text-fourtyLight align-baseline' />
                )}
              </label>
