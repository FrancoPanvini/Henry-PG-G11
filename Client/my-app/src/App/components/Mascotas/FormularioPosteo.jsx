        ...
        <form className='panel flex flex-col w-4/5 min-w-max mx-auto bg-gradient-to-r from-primaryDark to-primary relative'>
          ...
          <div className='flex justify-between h-full'>
            <div className='flex flex-col'>
              ...
              <textarea name='description' placeholder='Ej.: Tiene 6 meses, se lleva bien con otras mascotas, tiene sus vacunas, etc...' onChange={handleChange} className='rounded-md px-1' />
              <br />
            ...
            <div className='h-auto w-full flex flex-col justify-center ml-4'>
              <div className=''>Ubicación de la Mascota:</div>
