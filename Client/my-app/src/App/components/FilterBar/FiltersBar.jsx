...
function FiltersBar() {
  ...
  return (
    <div>
      <div className='px-2 pt-2 ml-4 w-full h-7 font-bold text-thirty text-2xl border-t-2 border-thirtyLight border-opacity-50'>
        Filtrar resultados:
      </div>
      {currentLocation === '/adopciones' ? (
        <div className='r w-full px-8 py-4 ml-4 bg-transparent rounded-sm '>
          <div className='p-1 mb-2 flex flex-col justify-start border-b-2 border-thirtyLight border-opacity-50'>
            ...
            <div className='h-7'>
              <button
                ...
                name='type'
                onClick={handleSetUrl}
                className={`w-16 btn-nav text-white ${urlFilter.type === 'p' ? ' bg-thirtyDark' : 'btn bg-thirtyLight'}`}>
                Perro
              </button>
            </div>
            <div className='h-7 mb-2'>
              <button
                ...
                name='type'
                onClick={handleSetUrl}
                className={`w-16 btn-nav text-white ${urlFilter.type === 'g' ? ' bg-thirtyDark' : 'btn bg-thirtyLight'}`}>
                Gato
              </button>
            </div>
          </div>
          ...
          <div className='p-1 mb-2 flex flex-wrap justify-between items-center border-b-2 border-thirtyLight border-opacity-50'>
            ...
            <button
              type='submit'
              className={urlFilter.agemin || urlFilter.agemax ? 'btn bg-primary p-1 rounded-lg disabled:opacity-50 mb-2' : 'btn p-1 mb-2 invisible'}
              onClick={handleSend}>
              Aplicar
            </button>
          </div>
          ...
          <div className='p-1 mb-2 flex flex-col justify-start border-b-2 border-thirtyLight border-opacity-50'>
            ...
            <div className='h-7'>
              <button
                ...
                name='size'
                onClick={handleSetUrl}
                className={`w-20 btn-nav text-white transition-all ${urlFilter.size === 'c' ? ' bg-thirtyDark' : 'btn bg-thirtyLight'}`}>
                Pequeño
              </button>
            </div>
            <div className='h-7'>
              <button
                ...
                name='size'
                onClick={handleSetUrl}
                className={`w-20 btn-nav text-white transition-all ${urlFilter.size === 'm' ? ' bg-thirtyDark' : 'btn bg-thirtyLight'}`}>
                Mediano
              </button>
            </div>
            <div className='h-7 mb-2'>
              <button
                ...
                name='size'
                onClick={handleSetUrl}
                className={`w-20 btn-nav text-white transition-all ${urlFilter.size === 'g' ? ' bg-thirtyDark' : 'btn bg-thirtyLight'}`}>
                Grande
              </button>
            </div>
          </div>
          ...
          <div className='p-1 mb-2 flex flex-col justify-start border-b-2 border-thirtyLight border-opacity-50'>
            ...
            <div className='h-7'>
              <button
                ...
                name='gender'
                onClick={handleSetUrl}
                className={`w-20 btn-nav text-white transition-all ${urlFilter.gender === 'm' ? ' bg-thirtyDark' : 'btn bg-thirtyLight'}`}>
                Macho
              </button>
            </div>
            <div className='h-7 mb-2'>
              <button
                ...
                name='gender'
                onClick={handleSetUrl}
                className={`w-20 btn-nav text-white transition-all ${urlFilter.gender === 'h' ? ' bg-thirtyDark' : 'btn bg-thirtyLight'}`}>
                Hembra
              </button>
            </div>
          </div>
        ...
        <div className='p-8 ml-4 bg-transparent rounded-sm'>
