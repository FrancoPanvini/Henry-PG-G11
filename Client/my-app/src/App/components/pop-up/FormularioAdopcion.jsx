            ...
            <form>
              ...
              <div>
                ...
                <p className='text-white'>
                  Agradecemos tu interés por <span className='font-bold text-primary capitalize'>{name}</span>, para considerar tu solicitud de adopción necesitamos conocerte un poco más, por favor
              ...
              <FormularioAdopcionSelect
                label='Cantidad de niños o niñas en la residencia: '
                name='residents'
                options={['0', '1-3', '4-6', 'más de 6']}
                values={['0', '1-3', '4-6', 'más de 6']}
