  ...
  return (
    <div className='w-auto h-5/6'>
      <ReactCardFlip isFlipped={isFlipped} flipDirection='horizontal' className=''>
        <div
          onClick={handleClick}
          className='w-80 h-96 grid justify-items-center cursor-pointer bg-primaryDark rounded-2xl overflow-hidden'>
        ...
        <div className='h-96 w-80 bg-primary rounded-2xl '>
          <div onClick={handleClick} className='flex flex-col h-full items-center w-full  cursor-pointer'>
            <div className='font-bold text-xl p-6 text-fourty capitalize'>{name}</div>
            ...
            <div className='text-center'>
              ...
              <h3 className='p-1 text-white font-bold'>
                Tamaño:{' '}
                <span className='text-fourty capitalize'>{size === 'c' ? 'pequeño' : size === 'm' ? 'mediano' : 'grande'}</span>
              </h3>
              <h3 className='p-1 text-white font-bold'>
