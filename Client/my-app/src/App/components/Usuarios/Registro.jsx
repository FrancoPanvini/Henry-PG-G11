...
function Registro() {
  ...
  const validate = ({ name, mail, phoneCode, phone, direction, password, confirmPassword }) => {
    let errors = {};
    if (!name) {
    ...
    if (phoneCode && phoneCode.length !== 2) {
      errors.phoneCode = 'Debes seleccionar una opción de la lista';
    }
    if (!phone) {
          ...
          <div className='flex gap-8 overflow-auto my-4'>
            <div className='flex flex-col w-2/5 relative'>
              ...
              <div className='flex gap-2'>
                <div className='w-1/4'>
                  <label className='text-white'>
                    País: <ErrorIconPulsing error={errors.phoneCode} color='primary' />
