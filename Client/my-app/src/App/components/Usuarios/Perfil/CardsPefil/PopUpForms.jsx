  ...
  return (
    <>
      ...
      <div className='z-50 p-4 rounded-lg h-96 bg-primaryDark text-white m-2'>
        ...
        <h2>
          Provincia:{' '}
          <span className='capitalize font-bold'>{user?.province}</span>{' '}
        </h2>
        <h2>
        ...
        <h2>
          Tipo de propiedad:
          <span className=' font-bold'>
            {residence === ' app' ? ' Departamento' : ' Casa'}
          </span>
        </h2>
        <h2>
          Cuantas personas viven en su propiedad:{' '}
          <span className=' font-bold'>{residents} personas</span>
        </h2>
          ...
          {state === 'p' ? (
            <>
              ...
              <button
                ...
                className='btn bg-white text-black font-bold rounded-lg hover:bg-green-600 hover:text-white p-2 '>
                Aceptar
              </button>
              <a
