...
const CardAdopcion = ({photo, name, created}) => {
  ...
  const timeAgo = new Intl.RelativeTimeFormat().format(diffDays, 'days');
    ...
    return(
        ...
        <div className="">
          <img src={photo? photo :'https://drpp-ny.org/wp-content/uploads/2014/07/sorry-image-not-available.png'} alt="" className="w-16 h-16 rounded-full object-cover ring-4 ring-gray-600 ring-opacity-50 transform duration-100 hover:scale-125 hover:pointer " />
        </div>
